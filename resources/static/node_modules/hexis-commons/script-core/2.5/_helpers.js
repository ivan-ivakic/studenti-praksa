...
function closest(target, wantedSelector, limiterSelector) {
  var current = target;
  var wantedSelector = wantedSelector || '';
...
/*------------------------------------------------------------------------------------
  Accepts a selector string or a dom node
  Always returns the dom node (or the first result of an array of nodes)
------------------------------------------------------------------------------------*/
window.getDomNode = function(target) {
  if (typeof target === 'string') {
    ...
    console.error('getDomNode()', 'Unsupported target', target);
  }
}
...
/*------------------------------------------------------------------------------------
  Deferred click events without jQuery. Default scope is document.body, but you can
  specify a custom scope.

  Sample usage:
  App.handleClick('.mySelector', function(){ Callback code... });
  App.handleClick('.mySelector', '.scopeSelector', function(){ Callback code... });
------------------------------------------------------------------------------------*/
App.handleClick = function(targetSelector, scopeSelector, callback, outsideClick) {

  // Resolve scope
  var scope = document.body;
  if (scopeSelector !== null && scopeSelector !== false && scopeSelector !== undefined) {
    scope = getDomNode(scopeSelector);
  }

  // Resolved outside click
  outsideClick = outsideClick || function(){};

  // Resolve target element
  var target = getDomNode(targetSelector);

  // Add event listener
  scope.addEventListener('click', function(e){
    var wantedNode = closest(e.target, targetSelector, scopeSelector);
    if (wantedNode !== false) {
      callback(e, wantedNode);
    } else {
      outsideClick(e);
    }
  }, false);
...
------------------------------------------------------------------------------------*/
window.fastClick = function(target, callback) {
...
App.checkIfVisible = function(el, targetScope, tresholdMultiplier) {
  ...
  else if (targetScope !== null && scope !== document.body) { scope = document.querySelector(targetScope); }
