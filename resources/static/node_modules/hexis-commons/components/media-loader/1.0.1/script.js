App.mediaLoader = {
  ...
  check: function(target) {
    ...
    localNodes.each(function App_mediaLoader_check_eachLoop(i) {
      if (App.checkIfVisible(localNodes[i], App.mediaLoader.tresholdMultiplier)=== true) {
  ...
  finishedLoading: function (node, url, callback) {
    console.info('App.mediaLoader.done("'+ url +'")');
  ...
  waitForAll: function(target, callback) {
    ...
    if (localNodes.length === 0) {
      console.info('App.mediaLoader.waitForAll: No images were found within this selector!');
      callback();
      return;
    }
